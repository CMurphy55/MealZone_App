...
class RecyclerViewFragment : Fragment(), AnkoLogger, Callback<List<TransferModel>> {
    ...
    fun getAllMeals() {
        ...
        var callGetAll = app.mealService.getall()
        callGetAll.enqueue(this)
    }

    fun deleteMeal(id: String) {
        showLoader(loader, "Deleting Meal $id")
        var callDelete = app.mealService.delete(id)
